...
const Banner = () => {
  return (
    <section className=" bg-cover bg-center bg-[#2A2895] pt-32 pb-20 lg:pt-40 lg:pb-32 relative ">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row  pt-8 items-center justify-center lg:justify-between">
        ...
        <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0 relative z-10">
         ...
         <span className=''> ..</span> trendy application
          ...
          <h1 className="text-5xl w-200 md:text-6xl lg:text-7xl font-extrabold text-white leading-tight"> Work Faster With <span >Powerful Tools</span>
          </h1>
          <p className="mt-6 w-[min(23em,90%)] text-lg text-gray-300 max-w-md lg:max-w-xl mx-auto lg:mx-0">Laboris culpa eu incididunt dolore ipsum tempor duis do ullamco euismod officia magna ad id.
          </p>
        ...
        <div className="">
          <img className=' h-75 object-fill ' src={banimg} alt="" />
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10 overflow-hidden">
            <h2 className="text-[200px] lg:text-[400px] font-extrabold text-white select-none pointer-events-none"> WORK FASTER POWERFUL TOOLS
            </h2>
        </div>
      </div>
    </section>
