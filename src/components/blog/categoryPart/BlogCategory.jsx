    ...
    <section className="pb-16 md:pb-24 lg:pb-30 mb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-24">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          {/* Main grid */}
          <div className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-8 w-full">
            ...
            <div className="w-full">
              ...
              {/* Recent Posts */}
              <h3 className="text-[22px] sm:text-[26px] lg:text-[28px] font-semibold font-c">
                Recent posts
              </h3>
              ...
              <div className="space-y-3 mt-3">
                <p className="text-[#FF6231] text-[12px] font-roboto">
                  Dec 10, 2020
                </p>
                <h3 className="text-[18px] sm:text-[20px] lg:text-[22px] font-mono">
                  Launch of a new convenient feature this Saturday...
                </h3>
                <h4 className="text-[16px] sm:text-[18px] font-roboto">
                ...
                <h2 className="text-[18px] sm:text-[20px] lg:text-[22px] font-semibold font-c">
              ...
              {/* Recent Comments */}
              <h3 className="text-[22px] sm:text-[26px] lg:text-[28px] font-semibold font-c mt-6">
                Recent comments
              </h3>
              <span className="block text-gray-400">
                - - - - - - - - - - - - - - - - - - - -
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 mt-4">
                {images.map((img, index) => (
                  <div key={index} className="aspect-square overflow-hidden border">
                    <img
                      src={img}
                      alt={`image-${index}`}
