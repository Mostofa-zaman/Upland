...
const Easy = () => {
  return (
    <section className="w-full bg-white py-16 sm:py-20 lg:py-24 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div>
          ...
          <p className="text-gray-500 text-base leading-7 mb-10 
                        w-full sm:max-w-md lg:w-[430px]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            {/* Google Play */}
            <button className="flex items-center gap-3 bg-orange-500 text-white 
                               px-8 sm:px-10 py-4 rounded-full font-medium shadow-md">
            ...
            {/* App Store */}
            <button className="flex items-center gap-3 border-2 border-orange-500 
                               text-orange-500 px-7 py-4 rounded-full font-medium">
              <span className="text-xl"></span>
              <span className="text-sm leading-tight text-left">
                Download on the <br />
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-10">
          ...
          <div className="text-left">
            ...
            <h3 className="text-3xl sm:text-4xl font-semibold mb-1">
